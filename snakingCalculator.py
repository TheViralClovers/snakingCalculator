...
total_count = common_count+uncommon_count+rare_count+classic_count+sketch_count
...
total_row = list(("TOTAL",total_count, total_snake, (total_snake/10)))
final_table_list = list((common_row,uncommon_row,rare_row,classic_row,sketch_row,total_row))
